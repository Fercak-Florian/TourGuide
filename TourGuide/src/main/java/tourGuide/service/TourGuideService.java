...
public class TourGuideService {
     ...
     * This method contains ASYNCHRONOUS TECHNOLOGY
     * When this method is called, GPS_UTIL.getUserLocation() method is running into a separated thread by supplyAsync method
     * which is waiting for the result. When the result of getUserLocation() method id available,
